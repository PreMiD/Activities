...
const getTitle = (): string | undefined => 
  document.querySelector('h1.contentTitle')?.textContent?.trim();

const getAuthor = (): string | undefined => 
  (document.querySelector('a#wcf1.userLink') || document.querySelector('.contentHeader .userLink'))?.textContent?.trim();
