...
presence.on('UpdateData', async () => {
  try {
    ...
    console.log("[OpenGuessr] Current pathname:", pathname);
    console.log("[OpenGuessr] Full URL:", fullUrl);
      ...
      try {
        ...
        if (roomCodeElement && roomCodeElement.textContent) {
          ...
          if (roomCode) {
            ...
            console.log(`[OpenGuessr] Room code found: ${roomCode}, adding join button`);
          }
        }
      } catch (e) {
    ...
    console.log("[OpenGuessr] Presence updated:", {
      pathname,
      presenceData,
