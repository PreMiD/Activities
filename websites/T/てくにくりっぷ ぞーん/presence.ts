...
presence.on('UpdateData', async () => {
  const presenceData: PresenceData = {
    ...
    largeImageKey: 'https://wsrv.nl/?url=https://zone.techniclip.com/static/icons/icon.png&w=512&h=512&output=png&ext=.png', // Replace with a direct URL to the site logo
  }
