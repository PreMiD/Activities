...
import type { Resolver, AppStrings } from './util/interfaces.js';
...
presence.on('UpdateData', async () => {
  ...
  // C'est ICI que la magie opère : on récupère les VRAIES traductions
