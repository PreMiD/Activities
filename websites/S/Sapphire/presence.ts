...
presence.on("UpdateData", async () => {
  ...
  if (hostname === "sapph.xyz") {
    if (pathname === "/") presenceData.state = t.home.main;
    else if (pathname.includes("/about")) presenceData.state = t.home.about;
    else if (pathname.includes("/status")) presenceData.state = t.home.status;
    else if (pathname.includes("/custom-branding")) presenceData.state = t.home.custombranding;
    else if (pathname.includes("/limit-increase")) presenceData.state = t.home.limitincrease;
    else if (pathname.includes("/terms")) presenceData.state = t.home.terms;
    else if (pathname.includes("/privacy")) presenceData.state = t.home.privacy;
    else if (pathname.includes("/right-of-withdrawal")) presenceData.state = t.home.rightofwithdrawal;
    else if (pathname.includes("/licenses")) presenceData.state = t.home.licenses;
    else if (pathname.includes("/legal-notice")) presenceData.state = t.home.legalnotice;
  }
  ...
  if (hostname === "docs.sapph.xyz") {
    presenceData.state = pathname === "/" ? t.docs.main : t.docs.reading;
  }
