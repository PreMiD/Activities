...
const FR: PresenceStrings = {
  ...
  viewCollection: 'Consulte une collection',
  collectionId: 'Collection {0}',
  viewMovie: 'Consulte la fiche d\'un film',
  movieId: 'Film {0}',
  viewSeries: 'Consulte la fiche d\'une série',
  seriesId: 'Série {0}',
  downloadMovie: 'Prépare le téléchargement d\'un film',
  downloadSeries: 'Prépare le téléchargement d\'une série',
  ...
  viewPerson: 'Consulte la fiche d\'une personne',
  personId: 'Personne {0}',
  ...
  viewList: 'Consulte une liste publique',
  listId: 'Liste {0}',
  ...
  ftv: 'France.tv',
  viewFtvProgram: 'Consulte un programme France.tv',
...
const EN: PresenceStrings = {
  ...
  collections: 'Collections',
  viewCollection: 'Viewing a collection',
  collectionId: 'Collection {0}',
  viewMovie: 'Viewing a movie page',
  movieId: 'Movie {0}',
  viewSeries: 'Viewing a TV show page',
  seriesId: 'TV show {0}',
  downloadMovie: 'Preparing a movie download',
  downloadSeries: 'Preparing a TV show download',
  ...
  bip39: 'BIP39 sign-in',
  viewPerson: 'Viewing a person\'s page',
  personId: 'Person {0}',
  ...
  viewList: 'Viewing a public list',
  listId: 'List {0}',
  ...
  ftv: 'France.tv',
  viewFtvProgram: 'Viewing a France.tv program',
  programId: 'Program {0}',
