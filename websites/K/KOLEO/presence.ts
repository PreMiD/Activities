    ...
    if (
      ...
      if (pathname.startsWith('/my/account')) {
        ...
        if (pathname.startsWith('/my/finances/') && !pathname.includes('invoice-details') && !pathname.includes('transactions')) {
          ...
          else if (pathname.endsWith('/postal-order')) title = 'przekazu pocztowym'
          else if (pathname.endsWith('/payment-cards')) title = 'karty płatniczej'
          else if (pathname.endsWith('/gift-card')) title = 'karty podarunkowej'
