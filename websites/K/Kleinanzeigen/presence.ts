...
presence.on('UpdateData', async () => {
  const strings = await presence.getStrings({
    ...
    sAnbieter: 'kleinanzeigen.sAnbieter',
    privat: 'kleinanzeigen.privat',
    gewerblich: 'kleinanzeigen.gewerblich',
    anzeige: 'kleinanzeigen.anzeige',
    angebote: 'kleinanzeigen.angebote',
    gesuche: 'kleinanzeigen.gesuche',
    versand: 'kleinanzeigen.versand',
    ja: 'kleinanzeigen.ja',
    nein: 'kleinanzeigen.nein',
    globalFarbe: 'kleinanzeigen.globalFarbe',
    globalZustand: 'kleinanzeigen.globalZustand',
    ...
    schwarz: 'kleinanzeigen.schwarz',
    weiss: 'kleinanzeigen.weiss',
    gold: 'kleinanzeigen.gold',
    silber: 'kleinanzeigen.silber',
    blau: 'kleinanzeigen.blau',
    rot: 'kleinanzeigen.rot',
    gruen: 'kleinanzeigen.gruen',
  ...
  if (path.includes('/s-anzeige/')) {
    ...
    const categoryMap: Record<string, string> = {
      's-anbieter': strings.sAnbieter,
      'privat': strings.privat,
      'gewerblich': strings.gewerblich,
      'anzeige': strings.anzeige,
      'angebote': strings.angebote,
      'gesuche': strings.gesuche,
      'versand': strings.versand,
      'ja': strings.ja,
      'nein': strings.nein,
      'global.farbe': strings.globalFarbe,
      'global.zustand': strings.globalZustand,
      ...
      'schwarz': strings.schwarz,
      'weiss': strings.weiss,
      'gold': strings.gold,
      'silber': strings.silber,
      'blau': strings.blau,
      'rot': strings.rot,
      'gruen': strings.gruen,
